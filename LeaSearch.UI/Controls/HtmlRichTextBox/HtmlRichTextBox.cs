...
using LeaSearch.UI.Controls.HtmlRichTextBox.Formatters;

namespace LeaSearch.UI.Controls.HtmlRichTextBox
{
    public class HtmlRichTextBox : System.Windows.Controls.RichTextBox
    {
        ...
        public HtmlRichTextBox(System.Windows.Documents.FlowDocument document)
            : base(document)
        {
        ...
        {
            HtmlRichTextBox rtb = (HtmlRichTextBox)d;
