...
namespace LeaSearch.Infrastructure.Storage
{
    ...
    public class BinaryStorage<T>
    {
        ...
        private T Deserialize(FileStream stream, T defaultData)
        {
            ...
            {
                Logger.Logger.Exception($"|BinaryStorage.Deserialize|Deserialize error for file <{FilePath}>", e);
        ...
        public void Save(T data)
        {
            using (var stream = new FileStream(FilePath, FileMode.Create))
            {
                ...
                {
                    Logger.Logger.Exception($"|BinaryStorage.Save|serialize error for file <{FilePath}>", e);
                }
            }
        }
    }
